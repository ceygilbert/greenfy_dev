	...
	return (
		<div className={styles.container}>
			...
			<div className={styles.splash}>
				...
				<div className={styles.title}>Recycle unused items better with Artificial Intelligence</div>
				<div className={styles.subtitle}>Take a picture of a item and learn how to recycle effectively.</div>
