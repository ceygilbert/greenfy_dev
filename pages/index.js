...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>
          Greenfy - Recycle unused items better with AI
        </title>
        <meta
          name="title"
          content="Greenfy - Recycle unused items better with AI"
        />
        <meta
          name="description"
          content="Greenfy is an innovative platform that leverages AI technology to help users recycle unused items more effectively. By utilizing advanced algorithms, Greenfy can suggest optimal recycling methods for various items, promoting sustainability and environmental consciousness."
        />
